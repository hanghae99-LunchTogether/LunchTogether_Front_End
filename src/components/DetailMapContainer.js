...
const DetailMapContainer = props => {
  ...
  useEffect(() => {
    ...
    var iwContent = `<div style="padding:5px; font-size: 1.4rem; text-align: center">${location.place_name} <br><a href=${location.place_url} style="color:blue" target="_blank">카카오맵 보기</a></div>`, // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
